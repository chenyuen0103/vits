...
```
python train.py --name waterbirds_exp --model_arch ViT --model_type ViT-S_16 --dataset waterbirds --warmup_steps 100 --num_steps 700 --learning_rate 0.03 --batch_split 16 --img_size 384
```
